...
public class Lineitem implements Record {
    ...
    public AbstractDate l_shipdate;
    public AbstractDate l_commitdate;
    public AbstractDate l_reciptdate;
    // @MaxLength(length = 25)
    ...
    public Lineitem(int l_orderkey, int l_partkey, int l_suppkey, int l_linenumber, Numeric l_quantity, Numeric l_extendedprice, Numeric l_discount, Numeric l_tax, Char l_returnflag, Char l_linestatus, Date l_shipdate, Date l_commitdate, Date l_reciptdate) {
