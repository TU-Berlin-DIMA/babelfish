...
public class DataSourceQuery3 {

    public static LogicalOperator relationalQuery3(LogicalOperator scanCustomer, LogicalOperator scanOrders, LogicalOperator scanLineitems) {
