...
EqualBenchmark () {
  ./scripts/luth_string_benchmark.sh equals "$1" "$2"
}

CopyBenchmark () {
  ./scripts/luth_string_benchmark.sh copy "$1" "$2"
}

LowercaseBenchmark () {
  ./scripts/luth_string_benchmark.sh lowercase "$1" "$2"
}

UppercaseBenchmark () {
  ./scripts/luth_string_benchmark.sh uppercase "$1" "$2"
}

SubstringBenchmark () {
  ./scripts/luth_string_benchmark.sh substring "$1" "$2"
}
ReverseBenchmark () {
  ./scripts/luth_string_benchmark.sh reverse "$1" "$2"
}
ConcatBenchmark () {
  ./scripts/luth_string_benchmark.sh concat "$1" "$2"
}
UppercaseBenchmark () {
  ./scripts/luth_string_benchmark.sh uppercase "$1" "$2"
}
...
lazy_string_handling=(true false)

### Equal Benchmark
for use_ropes in ${lazy_string_handling[*]}; do   # The quotes are necessary here
