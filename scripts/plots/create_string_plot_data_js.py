...
data = pd.read_csv("../../results/StringBenchmark.csv",index_col=False, names=["data", "query", "language", "lazy",
"ts_1_min", "ts_1_max", "ts_1_avg", "ts_2_min", "ts_2_max", "ts_2_avg"])
ds = data[data["language"]=="js"]
...
result.to_csv('stringBenchmark_plot_data_js.csv')
